 ...
 * </p>
 * <ul>
 *   <li>{@link scheduling.dsl.impl.NullExpressionImpl#getProcName <em>Proc Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NullExpressionImpl extends ExpressionImpl implements NullExpression
{
  ...
  {
    return DslPackage.eINSTANCE.getNullExpression();
  }
  ...
  public NotificationChain basicSetProcName(scheduling.dsl.Process newProcName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DslPackage.NULL_EXPRESSION__PROC_NAME, oldProcName, newProcName);
  ...
  public void setProcName(scheduling.dsl.Process newProcName)
  {
    if (newProcName != procName)
    {
      ...
      if (procName != null)
        msgs = ((InternalEObject)procName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DslPackage.NULL_EXPRESSION__PROC_NAME, null, msgs);
      if (newProcName != null)
        msgs = ((InternalEObject)newProcName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DslPackage.NULL_EXPRESSION__PROC_NAME, null, msgs);
      msgs = basicSetProcName(newProcName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.NULL_EXPRESSION__PROC_NAME, newProcName, newProcName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslPackage.NULL_EXPRESSION__PROC_NAME:
