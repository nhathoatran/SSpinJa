 ...
 * </p>
 * <ul>
 *   <li>{@link scheduling.dsl.impl.ParameterListImpl#getPara <em>Para</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterListImpl extends MinimalEObjectImpl.Container implements ParameterList
{
   ...
   * @ordered
   */
  protected EList<ParameterAssign> para;
  ...
  {
    return DslPackage.eINSTANCE.getParameterList();
  }
   ...
   */
  @Override
  public EList<ParameterAssign> getPara()
  {
    if (para == null)
    {
      para = new EObjectContainmentEList<ParameterAssign>(ParameterAssign.class, this, DslPackage.PARAMETER_LIST__PARA);
    }
    return para;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslPackage.PARAMETER_LIST__PARA:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case DslPackage.PARAMETER_LIST__PARA:
        getPara().clear();
        getPara().addAll((Collection<? extends ParameterAssign>)newValue);
        return;
    }
