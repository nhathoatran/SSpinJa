 ...
 * </p>
 * <ul>
 *   <li>{@link scheduling.dsl.impl.EmptyExpressionImpl#getCol <em>Col</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmptyExpressionImpl extends ExpressionImpl implements EmptyExpression
{
  ...
  {
    return DslPackage.eINSTANCE.getEmptyExpression();
  }
  ...
  public NotificationChain basicSetCol(SchedulerSet newCol, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DslPackage.EMPTY_EXPRESSION__COL, oldCol, newCol);
  ...
  public void setCol(SchedulerSet newCol)
  {
    if (newCol != col)
    {
      ...
      if (col != null)
        msgs = ((InternalEObject)col).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DslPackage.EMPTY_EXPRESSION__COL, null, msgs);
      if (newCol != null)
        msgs = ((InternalEObject)newCol).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DslPackage.EMPTY_EXPRESSION__COL, null, msgs);
      msgs = basicSetCol(newCol, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.EMPTY_EXPRESSION__COL, newCol, newCol));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslPackage.EMPTY_EXPRESSION__COL:
