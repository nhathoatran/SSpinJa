...
public abstract class PromelaTransitionFactory {
	...
	public class NonAtomicTransition extends PromelaTransition {
		...
		public NonAtomicTransition(int i) {
			this.uselessWeight = i ;
		}
		/*
		 * 0: useless
		 * 1: useful
		...
		public NonAtomicTransition() {
//			this.uselessWeight = 2 ; //default
		}
...
//			System.out.println("State from: " + stateFrom);
//			System.out.println("State to: " + stateTo);
