...
public class SCH_API_Expression extends Expression implements CompoundExpression {
	...
	public SCH_API_Expression(final Token token, final Specification spec, final String funcName, final String val) {
		super(token);
		specification = spec;
