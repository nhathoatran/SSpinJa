...
public class Promela implements PromelaConstants {
        ...
        public static final String C_STATE_PID = "_pid";
         public static final String C_STATE_SID = "_sid";
        ...
        public static final VariableType C_TYPE_SID             = VariableType.SID;
    ...
    private void copy(Promela dst, Promela src) {
        ...
        public void addSID(Proctype p) {
            Variable pid = new Variable(C_TYPE_SID, C_STATE_SID, -1, p);
            p.addVariable(pid, false);
        }
        public void addPC(Proctype p) {
                Variable pc = new Variable(C_TYPE_PROC_COUNTER, C_STATE_PROC_COUNTER, -1, p);
                int initial_pc = ((p.getNrActive() == 0) && (!p.getName().equals("never")) &&
                                                (!p.getName().equals("sporadic")) && (!p.getName().equals("initproc")) &&(!p.getName().equals("error"))) ? -1 : 0;
...
//		if (nrActive > 0 && !currentProc.argumentsIsEmpty())
//			throw new ParseException("Active process can not have parameters - at line " + id.beginLine +", column "+ id.beginColumn);
...
/* An init process */
  ...
  final public void sporadic() throws ParseException {
        State s;
    jj_consume_token(SPORADIC);
                currentProc = new Proctype(specification, -1, 0, "sporadic"); // a sporadic process has no PID
                automaton = currentProc.getAutomaton();
                specification.setSporadic(currentProc);
                currentProc.lastArgument();
                addPC(currentProc);
                declarations = true;
    jj_consume_token(LCURLY);
  ...
  final public void error() throws ParseException {
    ...
    jj_consume_token(ERROR);
                currentProc = new Proctype(specification, -1, 0, "error"); // a error process define error states 
                automaton = currentProc.getAutomaton();
                specification.setError(currentProc);
                currentProc.lastArgument();
                addPC(currentProc);
                declarations = true;
    jj_consume_token(LCURLY);
  ...
  final public void verify() throws ParseException {
    ...
    jj_consume_token(VERIFY);
                currentProc = new Proctype(specification, -1, 0, "verify"); // a verify process define verify formula 
                automaton = currentProc.getAutomaton();
                specification.setVerify(currentProc);
                currentProc.lastArgument();
                addPC(currentProc);
                declarations = true;
    jj_consume_token(LCURLY);
  ...
  final public void initproc() throws ParseException {
        State s;
    jj_consume_token(INITPROC);
                currentProc = new Proctype(specification, -1, 0, "initproc");
                automaton = currentProc.getAutomaton();
                specification.addProc(currentProc);
                currentProc.lastArgument();
        addPC(currentProc);
...
/*** All expression statements ***/
  final public Expression varref(Identifier context) throws ParseException {
    ...
    if (getToken(1).kind == IDENTIFIER &&
      ...
      dot = jj_consume_token(COLON);
        if (currentProc != specification.getNever() && currentProc != specification.getSporadic()
                        && currentProc != specification.getInitProc() && currentProc != specification.getError())
  ...
  final public Expression base_expr() throws ParseException {
        Expression ex1 = null, ex2, ex3, at = null;
        Expression tcl_ex, ex ;
        Token t, id, id2;
        String val = "";
        Token id1 ;
      ...
      default:
        ...
        if (jj_2_57(2147483647)) {
          ...
          {if (true) return runExpr;}
            break;
          case SCH_EXEC:
            t = jj_consume_token(SCH_EXEC);
            jj_consume_token(LPAREN);
            id = jj_consume_token(IDENTIFIER);
          SCH_EXEC_Expression execExpr = new SCH_EXEC_Expression(t, id.image);
            jj_consume_token(LPAREN);
            arg_lst(execExpr);
            jj_consume_token(RPAREN);
            jj_consume_token(RPAREN);
          {if (true) return execExpr;}
            break;
          case SCH_EXEC_COMP:
            t = jj_consume_token(SCH_EXEC_COMP);
            jj_consume_token(LPAREN);
            id = jj_consume_token(IDENTIFIER);
          SCH_EXEC_COMP_Expression execCompExpr = new SCH_EXEC_COMP_Expression(t, id.image);
            jj_consume_token(LPAREN);
            arg_lst(execCompExpr);
            jj_consume_token(RPAREN);
            jj_consume_token(LPAREN);
            val = parameter_list();
            jj_consume_token(RPAREN);
            jj_consume_token(RPAREN);
          execCompExpr.add_list_para(val) ;
          {if (true) return execCompExpr;}
            break;
          case FULL:
          case EMPTY:
          case NFULL:
          ...
          {if (true) return new ChannelOperation(t, ex1);}
            break;
          case SCH_API:
            t = jj_consume_token(SCH_API);
            jj_consume_token(LPAREN);
            id = jj_consume_token(IDENTIFIER);
            val = list_para();
            jj_consume_token(RPAREN);
          SCH_API_Expression apiExpr = new SCH_API_Expression(t, specification, id.image, val);
          {if (true) return apiExpr;}
            break;
          case SCH_API_SELF:
            t = jj_consume_token(SCH_API_SELF);
            jj_consume_token(LPAREN);
            id = jj_consume_token(IDENTIFIER);
            val = list_para();
            jj_consume_token(RPAREN);
                SCH_API_Expression apiSelfExpr ;
                if (val.trim().isEmpty()) {
                         apiSelfExpr = new SCH_API_Expression(t, specification, id.image, "running_process");
                }else {
                        apiSelfExpr = new SCH_API_Expression(t, specification, id.image, "running_process, " + val);
                }
          {if (true) return apiSelfExpr;}
            break;
          case GEN:
            ...
            val = list_para();
            jj_consume_token(RPAREN);
                GEN_Expression genExpr;
                if (val.trim().isEmpty()) {
                         genExpr = new GEN_Expression(t, specification, id.image, "");
                }else {
                        genExpr = new GEN_Expression(t, specification, id.image, val);
                }
          {if (true) return genExpr;}
            break;
          case SCH_GET:
            t = jj_consume_token(SCH_GET);
            jj_consume_token(LPAREN);
            id = jj_consume_token(IDENTIFIER);
            jj_consume_token(COMMA);
            ...
            id2 = jj_consume_token(IDENTIFIER);
            jj_consume_token(RPAREN);
          SCH_GET_Expression getExpr = new SCH_GET_Expression(t, specification, id.image, id1.image, id2.image);
          {if (true) return getExpr;}
            break;
          case CTL_AX:
          case CTL_AF:
          case CTL_AG:
          ...
          case AT:
            ...
            tcl_ex = ctl_expression();
                if (at == null)
                        {if (true) return tcl_ex;}
                else {
                        ex = new CTL_Expression(at, tcl_ex) ;
                        {if (true) return ex ;}
                }
            break;
          default:
  ...
  final public CTL_Expression ctl_expression() throws ParseException {
  CTL_Expression ex ;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LPAREN:
      ex = ctl_expr0();
  ...
  final public Expression at_expr() throws ParseException {
  Expression ex ;
    jj_consume_token(AT);
    ex = expr();
    jj_consume_token(COLON);
  ...
  final public CTL_Expression ctl_expr0() throws ParseException {
  Expression exp ;
  CTL_Expression ex;
    jj_consume_token(LPAREN);
    exp = expr();
    jj_consume_token(RPAREN);
          ex = new CTL_Expression(null, exp);
          {if (true) return ex;}
    throw new Error("Missing return statement in function");
  }

  final public CTL_Expression ctl_expr1() throws ParseException {
  CTL_Expression ex, ex1;
  Token t, n = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CTL_AX:
      t = jj_consume_token(CTL_AX);
      break;
    case CTL_AF:
      t = jj_consume_token(CTL_AF);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LTE:
    ...
    case CTL_AG:
      ...
      break;
    case CTL_EX:
      t = jj_consume_token(CTL_EX);
      break;
    case CTL_EF:
      t = jj_consume_token(CTL_EF);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LTE:
        jj_consume_token(LTE);
        n = jj_consume_token(NUMBER);
    ...
    ex1 = ctl_expression();
          if (n == null)
                ex = new CTL_Expression(null, t, ex1, "0") ;
          else
                ex = new CTL_Expression(null, t, ex1, n.image) ;
          {if (true) return ex;}
    throw new Error("Missing return statement in function");
  }

  final public CTL_Expression ctl_expr2() throws ParseException {
  CTL_Expression ex, ex1, ex2;
  Token t, n = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CTL_AU:
      t = jj_consume_token(CTL_AU);
      break;
    case CTL_EU:
      t = jj_consume_token(CTL_EU);
      break;
    default:
      jj_la1[91] = jj_gen;
      jj_consume_token(-1);
    ...
    ex2 = ctl_expression();
          if (n == null)
                ex = new CTL_Expression(null, t, ex1, ex2, "0") ;
          else
                ex = new CTL_Expression(null, t, ex1, ex2, n.image) ;
          {if (true) return ex;}
    throw new Error("Missing return statement in function");
  }

  final public String qualifiedname() throws ParseException {
        Token t, process, property ;
    process = jj_consume_token(IDENTIFIER);
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case DOT:
      t = jj_consume_token(DOT);
      property = jj_consume_token(IDENTIFIER);
                          {if (true) return process.image ;}
      break;
    default:
      jj_la1[93] = jj_gen;
      ;
  ...
  final public String number_list() throws ParseException {
        Token t;
        Token num ;
        String listnum = "";
    ...
    while (true) {
      ...
      listnum = number_list();
                          {if (true) return num.image + ", " + listnum ;}
    }
                {if (true) return num.image ;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public String Parameter() throws ParseException {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NUMBER:
      para = jj_consume_token(NUMBER);
      break;
    case IDENTIFIER:
      para = jj_consume_token(IDENTIFIER);
      break;
    default:
      jj_la1[95] = jj_gen;
      jj_consume_token(-1);
  ...
  final public String parameter_list() throws ParseException {
    ...
    while (true) {
      ...
      t = jj_consume_token(COMMA);
      listpara = parameter_list();
                  if (listpara == "")
                        {if (true) return para ;}
                  else
                        {if (true) return para + ", "  + listpara ;}
    }
         if (listpara == "")
                {if (true) return para ;}
          else
  ...
  final public String list_para() throws ParseException {
        Token t;
        String para ;
        String listpara = "";
    label_19:
  ...
  private boolean jj_3R_190() {
    if (jj_scan_token(CTL_EG)) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_188() {
    if (jj_scan_token(CTL_AG)) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_189() {
    if (jj_scan_token(CTL_EF)) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_187() {
    if (jj_scan_token(CTL_AF)) return true;
    Token xsp;
    xsp = jj_scanpos;
  ...
  private boolean jj_3R_121() {
    if (jj_scan_token(SCH_GET)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    if (jj_scan_token(COMMA)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
  ...
  private boolean jj_3R_120() {
    if (jj_scan_token(GEN)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
  ...
  private boolean jj_3R_119() {
    if (jj_scan_token(SCH_API_SELF)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    if (jj_3R_214()) return true;
    if (jj_scan_token(RPAREN)) return true;
  ...
  private boolean jj_3R_118() {
    if (jj_scan_token(SCH_API)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    if (jj_3R_214()) return true;
    if (jj_scan_token(RPAREN)) return true;
  ...
  private boolean jj_3R_116() {
    if (jj_scan_token(SCH_EXEC_COMP)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    if (jj_scan_token(LPAREN)) return true;
  ...
  private boolean jj_3R_115() {
    if (jj_scan_token(SCH_EXEC)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_scan_token(IDENTIFIER)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_3R_176()) return true;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x67fc00fe,0x67fc00fc,0x0,0x0,0x67fc0000,0x8000000,0x10000000,0x8000000,0x20000000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x40000,0x7f80000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x7f80000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xff00,0xff00,0x0,0x0,0x0,0x0,0x3f00,0xc000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x29,0x3f80,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x29,0x3f80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc0000004,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000,0xffff8000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3c000000,0xc0000000,0xc0000000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x1000,0x1000,0x100,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x2000,0x2000,0x2000,0x0,0x0,0x0,0x1000,0x20,0x2000,0x100,0x20,0x100,0x20,0x2000,0x100,0x0,0x5000,0x2000,0x5000,0x2000,0x5000,0x400,0x400,0x5000,0x5000,0x5000,0x5000,0x2000,0x5000,0x5000,0x5000,0x0,0x8,0x5000,0x5000,0x10000000,0x10000000,0x138000,0x20,0x0,0x2000,0x5000,0x400,0x400,0x5000,0x5000,0x5000,0x5000,0x2000,0x5000,0x5000,0x5000,0x5000,0x0,0x8,0x10000000,0x10000000,0x138000,0x20,0x2040,0x2040,0x40,0x1,0x2000,0x100,0x100,0x0,0x4,0x100,0x30000,0x30000,0x40000,0x40,0x40041,0x40,0x20000000,0x20000000,0x20000000,0x20000000,0x0,0x0,0x20000000,0x0,0x2000,0x0,0x2000,0x2000,0x280000,0x380000,0x1c00000,0x1c00000,0x2200000,0x2200000,0xc000000,0xc000000,0xf0000000,0xf0000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x1,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x80000,0x80000,0x0,0x80000,0x80000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000,0x0,0x80000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000,0x80000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x180,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x180,0x0,0x0,0x0,0x100000,0x0,0x0,0x0,0x200,0x80000,0x0,0x0,0x0,0x0,0x0,0x100000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x200,0x0,0x180000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3,0x3,0x4,0x8,0x10,0x20,0x40,0x0,0x100000,0x180000,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_5() {
      jj_la1_5 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_6() {
      jj_la1_6 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_7() {
      jj_la1_7 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
