...
//		w.appendLine(
//			"for(PromelaTransitionFactory holder = getState().getFirst(); holder != null && holder.getProcess() == getProcess(); holder = holder.getNext()) {")
//			.indent();
		w.appendLine(
				"for(PromelaTransitionFactory holder = getState().getFirst(); holder != null; holder = holder.getNext()) {")
				.indent();
