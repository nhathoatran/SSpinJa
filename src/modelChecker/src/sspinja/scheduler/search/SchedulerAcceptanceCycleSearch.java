...
public class SchedulerAcceptanceCycleSearch<M extends Model<T>, T extends Transition> extends
	SchedulerNestedDepthFirstSearch<M, T> {
	private static final long serialVersionUID = 7398754730284458428L;

	public SchedulerAcceptanceCycleSearch(M model, StateStore store, int stackSize,
	...
	protected String getDescription() {
		return "scheduler acceptance cycle";
	}
